...
for i in range(len(imgDir)) :
    img.append(cv2.imread(os.path.join(path, imgDir[i])))
    print(img[i].shape)
...
cv2.imshow('pic1', imgBackground)
#cv2.imshow('pic2', imgBackground[1] )
#cv2.imshow('pic3', imgBackground[2] )
#cv2.imshow('pic4', imgBackground[3] )
